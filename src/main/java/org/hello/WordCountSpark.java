...
public class WordCountSpark {
	public static void main(String[] args) throws IOException{
		...
		Path outputPath = new Path("hdfs://hadoop.master.com:9000/user/psathishcs/Input/Books/Science_Java");
		...
		JavaPairRDD<String, Integer> counts = words
			    ...
			    .reduceByKey((x, y) -> x + y);
		counts.saveAsTextFile("hdfs://hadoop.master.com:9000/user/psathishcs/Input/Books/Science_Java");
		spark.close();
	}
}
